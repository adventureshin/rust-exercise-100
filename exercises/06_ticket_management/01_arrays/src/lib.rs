...
pub struct WeekTemperatures {
    weekday_temperatures: [Option<i32>; 7],
}
...
fn week_day_to_index(weekday: &Weekday) -> usize {
    match weekday {
        Weekday::Monday => 0,
        Weekday::Tuesday => 1,
        Weekday::Wednesday => 2,
...
impl WeekTemperatures {
    pub fn new() -> Self {
        WeekTemperatures { weekday_temperatures: [None; 7] }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        let weekday_index = week_day_to_index(&day);
        self.weekday_temperatures[weekday_index]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        let weekday_index = week_day_to_index(&day);
        self.weekday_temperatures[weekday_index] = Some(temperature);
    }
}
